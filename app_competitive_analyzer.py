    ...
    with tab2:
        ...
        if 'precios' in metrics:
            ...
            if analyzer.price_vars:
                ...
                st.plotly_chart(fig_price_evol, use_container_width=True)
            ...
            if index_cols:
                ...
                st.plotly_chart(fig_price_index, use_container_width=True)
    ...
    with tab3:
        ...
        if 'unidades' in metrics:
            ...
            if ms_cols:
                ...
                st.plotly_chart(fig_ms_units, use_container_width=True)
